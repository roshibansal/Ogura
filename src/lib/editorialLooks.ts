...
export const HERO_LOOKS: HeroLook[] = [
  ...
  {
    id: "look-3",
    image: "/hero/rose-embroidered-set.jpg",
    alt: "Rose kurta with embroidered sleeves and a two-tone organza dupatta",
    label: "LOOK 03 | THREAD & ZARI ON SILK",
    boutique: "Meher & Noor",
    city: "Delhi",
    title: "Rose Embroidered Silk Kurta",
    price: 3799,
    originalPrice: 4899,
    slug: "rose-embroidered-set",
    focus: "54% 26%",
  },
  {
    id: "look-4",
...
export const EDITORIAL_PRODUCTS_MAP: Record<string, Product> = {
  ...
  "rose-embroidered-set": {
    id: "rose-embroidered-set",
    name: "Rose Embroidered Silk Kurta",
    brand: "Meher & Noor",
    price: 3799,
    originalPrice: 4899,
    category: "dresses",
    images: ["/hero/rose-embroidered-set.jpg"],
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: [
      { name: "Rose", hex: "#C98191" },
      { name: "Sage", hex: "#8B9E70" },
    ],
    description: "Ombre rose silk with floral thread and zari worked across the sleeves and hem, finished with cloth-covered buttons.",
    material: "Silk with thread and zari embroidery",
    inStock: true,
    tags: ["Embroidery", "Zari"],
